    ...
    return (
        <section>
            ...
            <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-[16px]">
                ...
                <CategoryCard id="tranference"  onClick={(ev) => { toggleModalSecond(), setInfo(ev.target.offsetParent) }} className="cursor-pointer hover:bg-gray-200 bg-gray-100  dark:hover:bg-secondary dark:bg-secondary_less" img="/categories/transference.png" text="Transferência" />
