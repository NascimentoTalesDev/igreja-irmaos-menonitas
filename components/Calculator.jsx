        ...
        <div className="w-full h-full flex flex-col justify-between">
            <div className="flex flex-col">
                ...
                <div className="mt-[80px] flex items-end">
                    <b className="">R$</b><TitleH2 className="ml-[10px] text-3xl" text={initialState} /><span>,00</span>                          
                </div>
            </div>

            <div className="absolute left-0 bottom-0 mb-[20px] flex items-center w-full">
                <div className="parent mx-auto">
                    <button value={7} onClick={(ev) => addValue(ev.target.value)} className="bg-slate-300 text-secondary div1 flex items-center justify-center">7</button>
                    ...
                    <button onClick={( )=> removeValue()} className="div12 flex items-center justify-center h-full bg-success">enter</button>
                </div>
            </div>
        </div>
    );
