    ...
    return (
        <div className={`${className}`}>
            ...
            {files?.length < 1 && (
                ...
                <label className="w-[80px] h-[80px] border border-gray-500 gap-2 cursor-pointer flex flex-col items-center rounded-lg m-auto bg-gray-100 dark:bg-secondary text-sm text-placeholder justify-center">
